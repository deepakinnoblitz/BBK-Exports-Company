...
app_include_js = [
    ...
    "/assets/company/js/attendance.js?v=3",
    ...
    "/assets/company/js/pwa_init.js?v=2",
    ...
    "/assets/company/js/desk_redirect.js?v=4",
]
...
scheduler_events = {
    "all": [
        ...
        "company.company.biometric.biometric_sync.evaluate_and_run_scheduled_sync"
    ],
    "daily": [
    ...
    "cron": {
        "0 1 1 * *": [
            "company.company.frontend_api.cron_allocate_conditional_leaves"
        ]
    }
}
...
spa_routes = [
    ...
    "whatsapp-automation", "whatsapp-settings", "whatsapp-campaigns", "lead-integration", "sales-target-entry", "role-permissions"
]
